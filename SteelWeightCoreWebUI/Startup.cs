...
namespace SteelWeightCoreWebUI {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            string connectionString = Configuration.GetConnectionString("DwMariaDB");

            services.AddDbContext<EFDbContext>(Options => Options.UseMySQL(connectionString));

            services.AddScoped<ISteelRepository, EFSteelRepository>();
